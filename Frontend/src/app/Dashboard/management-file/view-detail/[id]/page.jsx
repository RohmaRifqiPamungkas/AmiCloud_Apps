      ...
      onConfirm: () => {
        try {
          deleteFile(fileId).then(() => {
            router.push("/Dashboard/management-file?success=true&message=File deleted successfully");
          });
        }
        catch (error) {
        ...
        <div className="p-6 ">
          ...
          <div className="max-w-md mx-auto">
            <div className="flex justify-center my-4 pt-10">
              <div className="w-40 h-40 bg-purple-100 flex items-center justify-center rounded-lg">
...
export default withAuth(FileDetails);
