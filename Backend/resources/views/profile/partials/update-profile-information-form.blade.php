<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="full_name" name="full_name" type="text" class="mt-1 block w-full" :value="old('full_name', $user->full_name)" autocomplete="full-name" />
        ...
        <div>
            ...
            <x-text-input id="birthday_date" name="birthday_date" type="date" class="mt-1 block w-full" :value="old('birthday_date', $user->birthday_date)" autocomplete="bday" />
